...
const SearchBox: React.FC<SearchBoxProps> = ({
  ...
  return (
    ...
    <div
      className={`flex flex-col md:flex-row flex-wrap items-stretch gap-2 p-2 rounded-2xl shadow-lg transition-colors w-full ${
    ...
    >
      ...
      <div className="relative w-full md:w-auto">
        <select
          ...
          className={`appearance-none w-full pl-4 pr-8 py-2 rounded-xl transition-colors ${
